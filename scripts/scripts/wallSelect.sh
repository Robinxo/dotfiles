...
wall_dir=$(
  find "$base_wall_dir" -mindepth 1 -maxdepth 1 -type d -printf "%f\n" | sort | rofi -i -show -dmenu -theme $HOME/.config/rofi/wallpaper-select.rasi -theme-str $rofi_override
  "Choose Folder:"
)
...
wall_dir="$base_wall_dir/$wall_dir"
...
rofi_command="rofi -i -show -dmenu -theme $HOME/.config/rofi/wallpaper-select.rasi -theme-str $rofi_override"
